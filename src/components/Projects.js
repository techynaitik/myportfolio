            ...
            <TrackVisibility>
              {({ isVisible }) =>
                <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                  <h2>Projects</h2>
                  <p>In this section, you will find a collection of projects that highlight my expertise in Web Development, App Development, Machine Learning, and Software Development. Each project showcases my ability to design and build user-friendly web applications, develop mobile apps with seamless functionality, and integrate ML models into real-world solutions. From creating dynamic websites to deploying intelligent systems, my work reflects my passion for problem-solving and continuous learning. Explore my projects to see how I bring ideas to life through code and creativity.</p>
                  <Row>
